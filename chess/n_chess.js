...
class PieceMovement
{
    constructor(color, pieceType, location, toLocation, peplacedObj){
        this.Color = color;
        this.PieceType = pieceType;
        this.Location = location;
        this.ToLocation = toLocation;
        this.Replaced = peplacedObj;
    }
...
class Chess {
    ...
    AddMovement(move, duration = 5000)
    {
        ...
        if (!_from.Equals(_to)) {
            ...
            if (piece !== undefined) {
                ...
                if (canMove) {
                    ...
                    // var checkbefore = KingInCheckPosition(piece.Color); // PieceColors.Black ? PieceColors.White : PieceColors.White
                    ...
                    if (movedtocheck.Check) {
                        var res = new MoveResponse(piece
                    ...
                    {
                        this.AddMovement(new PieceMovement(piece.Color, piece.PieceType, _from, _to, (replacement ? new BasicPiece(checkOponent, targetObstruction.PieceType) : undefined)), duration);
                    }

                    var checkOponent = this.KingInCheckPosition(opponentColor);
                    this.Current = (this.Current === PieceColors.White) ? PieceColors.Black : PieceColors.White;
                    return new MoveResponse(piece, MoveStatus.Moved, "Done", targetObstruction, checkOponent);
                }
                else {
    ...
    KingInCheckPosition(color) {
        ...
        var checkSameLine = function (f, r) {
            ...
            if (targetObstruction) {
                ...
                if (targetObstruction.PieceType === Pieces.Queen
        ...
        return new CheckOponent(false, targetObstruction);
    }
...
exports.RankLoc = RankLoc;
exports.FileLoc = FileLoc;
exports.PieceColors = PieceColors;
exports.MoveStatus = MoveStatus;

exports.PiecesEnum = PiecesEnum;
exports.RankLocEnum = RankLocEnum;
exports.FileLocEnum = FileLocEnum;
exports.PieceColorsEnum = PieceColorsEnum;
exports.MoveStatusEnum = MoveStatusEnum;
exports.PieceHistoryItem = PieceHistoryItem;
exports.Piece = Piece;
exports.Placement = Placement;
exports.MoveResponse = MoveResponse;
exports.CheckOption1 = CheckOption1;
exports.CheckOponent = CheckOponent;
exports.PiecesChk = PiecesChk;
exports.BoardPieceMovement = BoardPieceMovement;
exports.PieceMovement = PieceMovement;
exports.BasicPiece = BasicPiece;
exports.Chess = Chess;
